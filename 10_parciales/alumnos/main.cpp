...
int main()
{
    ...
    */
    ...
    for(int i=0;i<cantidad;i++){
        AlumnoNormal *ptr1 = nullptr;
        AlumnoVocacional *ptr2 = nullptr;
        AlumnoLibre *ptr3 = nullptr;
        AlumnoEspecial *ptr4 = nullptr;
        if(ptr1 = dynamic_cast<AlumnoNormal *>((curso->getAlumno(i))))
               cout << " " <<*ptr1<< endl;;
        if(ptr2 = dynamic_cast<AlumnoVocacional *>((curso->getAlumno(i))))
               cout << " " << *ptr2<< endl;;
        if(ptr3 = dynamic_cast<AlumnoLibre *>((curso->getAlumno(i))))
               cout << " " << *ptr3<< endl;
        if(ptr4 = dynamic_cast<AlumnoEspecial *>((curso->getAlumno(i))))
               cout << " " << *ptr4<< endl;
       };
